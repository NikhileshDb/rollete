...
def add_dozen1(number):
    for i in Dozen1:
        if (i == number):
            dozen = Dozen.objects.create(dozen='1st')
            dozen.save()

def add_dozen2(number):
    for i in Dozen2:
        if (i == number):
            dozen = Dozen.objects.create(dozen='2nd')
            dozen.save()

def add_dozen3(number):
    for i in Dozen3:
        if (i == number):
            dozen = Dozen.objects.create(dozen='3rd')
            dozen.save()
...
def add_col1(number):
    for i in Col1:
        if (i == number):
            column = Column.objects.create(column='1st')
            column.save()

def add_col2(number):
    for i in Col2:
        if (i == number):
            column = Column.objects.create(column='2nd')
            column.save()

def add_col3(number):
    for i in Col3:
        if (i == number):
            column = Column.objects.create(column='3rd')
            column.save()
